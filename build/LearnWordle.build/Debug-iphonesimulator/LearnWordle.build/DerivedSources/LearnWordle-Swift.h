...
#ifndef LEARNWORDLE_SWIFT_H
#define LEARNWORDLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LearnWordle",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11LearnWordle11AppDelegate")
...
SWIFT_CLASS("_TtC11LearnWordle19BoardViewController")
@interface BoardViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (void)viewDidLoad;
...
@interface BoardViewController (SWIFT_EXTENSION(LearnWordle))
...
SWIFT_CLASS("_TtC11LearnWordle7KeyCell")
@interface KeyCell : UICollectionViewCell
...
SWIFT_CLASS("_TtC11LearnWordle22KeyboardViewController")
...
@interface KeyboardViewController (SWIFT_EXTENSION(LearnWordle)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView * _Nonnull)collectionView SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC11LearnWordle13SceneDelegate")
...
SWIFT_CLASS("_TtC11LearnWordle14ViewController")
